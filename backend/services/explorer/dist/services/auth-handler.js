...
export class AuthHandler {
    ...
    async authenticate(page, auth, baseUrl) {
    ...
    async authenticateWithCookies(page, auth, logger) {
        if (!auth.cookieData) {
    ...
    async authenticateWithScript(page, auth, baseUrl, logger) {
        if (!auth.loginScript) {
    ...
    async authenticateWithMagicLink(page, auth, baseUrl, logger) {
    ...
    async executeLoginActions(page, actions, logger) {
    ...
    async typeInElement(page, selector, value) {
