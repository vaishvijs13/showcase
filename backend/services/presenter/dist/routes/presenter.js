...
presenterRouter.post('/generate', async (req, res) => {
    try {
        const { scene, style, outputPath } = req.body;
...
presenterRouter.post('/generate-batch', async (req, res) => {
    try {
...
presenterRouter.post('/generate-ai', async (req, res) => {
    try {
        const { scene, outputPath } = req.body;
        ...
        const videoProcessor = new VideoProcessor();
        const processedVideoPath = await videoProcessor.processPresenterVideo(videoResult.videoUrl, finalPath, {
...
presenterRouter.get('/avatars', async (req, res) => {
    try {
...
presenterRouter.get('/voices', async (req, res) => {
    try {
...
presenterRouter.post('/test', async (req, res) => {
    try {
