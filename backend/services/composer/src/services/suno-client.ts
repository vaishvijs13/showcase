...
export interface SunoJobStatus {
  id: string;
...
export class SunoClient {
  ...
  async generateMusic(request: SunoMusicRequest): Promise<SunoMusicResponse> {
    try {
  ...
  private buildPrompt(request: SunoMusicRequest): string {
  ...
  private async waitForCompletion(jobId: string): Promise<SunoJobStatus> {
  ...
  async downloadAudio(audioUrl: string, outputPath: string): Promise<void> {
    try {
