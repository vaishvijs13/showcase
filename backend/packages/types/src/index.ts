...
export const FrameworkSchema = z.enum([
  'next', 'express', 'django', 'flask', 'react', 'vue', 'angular', 'other'
]);
...
// Enhanced schemas for AI-powered pipeline (defined early for dependencies)
...
// Additional enhanced schemas for AI-powered pipeline
